...
(cl:defclass <StampedEncoders> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (encoders
    :reader encoders
    :initarg :encoders
    :type ax2550-msg:Encoders
    :initform (cl:make-instance 'ax2550-msg:Encoders)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <StampedEncoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StampedEncoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ax2550-msg:<StampedEncoders> is deprecated: use ax2550-msg:StampedEncoders instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <StampedEncoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ax2550-msg:header-val is deprecated.  Use ax2550-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'encoders-val :lambda-list '(m))
(cl:defmethod encoders-val ((m <StampedEncoders>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ax2550-msg:encoders-val is deprecated.  Use ax2550-msg:encoders instead.")
  (encoders m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StampedEncoders>)))
  ...
  (cl:format cl:nil "Header header~%Encoders encoders~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ax2550/Encoders~%float32 time_delta # Time since last encoder update.~%int32 left_wheel  # Encoder counts (absolute or relative)~%int32 right_wheel # Encoder counts (absolute or relative)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StampedEncoders)))
  "Returns full string definition for message of type 'StampedEncoders"
  (cl:format cl:nil "Header header~%Encoders encoders~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: ax2550/Encoders~%float32 time_delta # Time since last encoder update.~%int32 left_wheel  # Encoder counts (absolute or relative)~%int32 right_wheel # Encoder counts (absolute or relative)~%~%~%"))
