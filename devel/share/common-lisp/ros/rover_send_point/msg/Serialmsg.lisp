...
(cl:defmethod cl:initialize-instance :after ((m <Serialmsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Serialmsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rover_send_point-msg:<Serialmsg> is deprecated: use rover_send_point-msg:Serialmsg instead.")))

(cl:ensure-generic-function 'motor-val :lambda-list '(m))
(cl:defmethod motor-val ((m <Serialmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_send_point-msg:motor-val is deprecated.  Use rover_send_point-msg:motor instead.")
  (motor m))

(cl:ensure-generic-function 'robotarm-val :lambda-list '(m))
(cl:defmethod robotarm-val ((m <Serialmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_send_point-msg:robotarm-val is deprecated.  Use rover_send_point-msg:robotarm instead.")
  (robotarm m))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <Serialmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_send_point-msg:battery-val is deprecated.  Use rover_send_point-msg:battery instead.")
  (battery m))

(cl:ensure-generic-function 'lora-val :lambda-list '(m))
(cl:defmethod lora-val ((m <Serialmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_send_point-msg:lora-val is deprecated.  Use rover_send_point-msg:lora instead.")
  (lora m))

(cl:ensure-generic-function 'sensor-val :lambda-list '(m))
(cl:defmethod sensor-val ((m <Serialmsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_send_point-msg:sensor-val is deprecated.  Use rover_send_point-msg:sensor instead.")
  (sensor m))
