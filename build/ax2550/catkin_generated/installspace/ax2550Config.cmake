...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ax2550' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hgaren/catkin_ws1/install/${idir}'.  Ask the maintainer 'William Woodall <wjwwood@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hgaren/catkin_ws1/install/lib;/home/hgaren/serial/build/devel/lib;/home/hgaren/catkin_ws1/devel/lib;/opt/ros/indigo/lib)
